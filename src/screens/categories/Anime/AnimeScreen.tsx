// screens/categories/Anime/AnimeScreen.tsx
// Màn hình hiển thị danh sách phim Anime
 ...
 */
const AnimeScreen: React.FC<AnimeScreenProps> = ({ navigation }) => {
  ...
  const loadMovies = async (pageNum: number = 1, isRefresh: boolean = false) => {
    try {
      ...
      const result = await movieService.getAnimeMovies({ page: pageNum });
      ...
      console.error('❌ Lỗi load Anime:', err);
    ...
    return (
      <LinearGradient colors={colors.gradientStart} style={styles.container}>
        ...
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.loadingText}>Đang tải Anime...</Text>
        </View>
      </LinearGradient>
    );
  }
